...
function App() {
  ...
  return (
    <div className="w-full">
      <header className="fixed top-0 left-0 w-full h-25 bg-gray-950 flex items-center justify-center z-10">
        <nav className="flex gap-x-10 items-center">
          <a href='#home' className='relative p-2 transition hover:text-green-400 hover:-translate-y-2 after:absolute after:w-0 after:h-0.5 after:left-0 after:-bottom-1 after:bg-green-400 after:transition-all hover:after:w-full'>Início</a>
      ...
      <aside className="hidden min-[1150px]:flex flex-col fixed top-0 left-8 items-center gap-4 z-10">
      ...
      <aside className="hidden min-[1150px]:flex flex-col fixed top-0 right-8 items-center gap-y-4 z-10">
        <div className="w-px h-24 bg-gray-500"></div>
