...
function App() {
  return (
    <div className="w-full">
      ...
      <aside className="hidden min-[1150px]:flex flex-col fixed bottom-0 left-8 items-center gap-4">
      ...
      <aside className="hidden min-[1150px]:flex flex-col fixed bottom-0 right-8 items-center gap-y-60">
      ...
      <footer className='flex justify-center py-4 text-gray-400'>
        <p>
